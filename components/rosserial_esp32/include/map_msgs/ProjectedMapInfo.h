...
namespace map_msgs
{
  ...
  class ProjectedMapInfo : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_min_z.base = 0;
      u_min_z.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_min_z.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_min_z.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_min_z.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_max_z.base = 0;
      u_max_z.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_z.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_z.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_z.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
