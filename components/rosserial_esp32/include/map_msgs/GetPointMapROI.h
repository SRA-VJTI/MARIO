...
static const char GETPOINTMAPROI[] = "map_msgs/GetPointMapROI";
  ...
  class GetPointMapROIRequest : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_l_x.base = 0;
      u_l_x.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_l_x.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_l_x.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_l_x.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->l_x = u_l_x.real;
      offset += sizeof(this->l_x);
      union {
        double real;
      ...
      u_l_y.base = 0;
      u_l_y.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_l_y.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_l_y.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_l_y.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->l_y = u_l_y.real;
      offset += sizeof(this->l_y);
      union {
        double real;
      ...
      u_l_z.base = 0;
      u_l_z.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_l_z.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_l_z.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_l_z.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->l_z = u_l_z.real;
      offset += sizeof(this->l_z);
     return offset;
    }
