...
static const char SETLIGHTPROPERTIES[] = "gazebo_msgs/SetLightProperties";
  ...
  class SetLightPropertiesRequest : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_attenuation_constant.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_attenuation_constant.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_attenuation_constant.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_attenuation_constant.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_attenuation_linear.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_attenuation_linear.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_attenuation_linear.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_attenuation_linear.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_attenuation_quadratic.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_attenuation_quadratic.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_attenuation_quadratic.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_attenuation_quadratic.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
