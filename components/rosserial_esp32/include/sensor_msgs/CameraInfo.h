...
namespace sensor_msgs
{
  ...
  class CameraInfo : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_st_D.base = 0;
      u_st_D.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_D.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_D.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_D.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_Ri.base = 0;
      u_Ri.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_Ri.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_Ri.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_Ri.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->R[i] = u_Ri.real;
      offset += sizeof(this->R[i]);
      }
      for( uint32_t i = 0; i < 12; i++){
      ...
      u_Pi.base = 0;
      u_Pi.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_Pi.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_Pi.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_Pi.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->P[i] = u_Pi.real;
      offset += sizeof(this->P[i]);
      }
