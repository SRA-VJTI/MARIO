...
namespace control_msgs
{
  ...
  class JointControllerState : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_process_value.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_process_value.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_process_value.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_process_value.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_process_value_dot.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_process_value_dot.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_process_value_dot.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_process_value_dot.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
