...
namespace gazebo_msgs
{
  ...
  class ODEPhysics : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_sor_pgs_w.base = 0;
      u_sor_pgs_w.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_sor_pgs_w.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_sor_pgs_w.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_sor_pgs_w.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_sor_pgs_rms_error_tol.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_sor_pgs_rms_error_tol.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_sor_pgs_rms_error_tol.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_sor_pgs_rms_error_tol.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_contact_surface_layer.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_contact_surface_layer.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_contact_surface_layer.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_contact_surface_layer.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_contact_max_correcting_vel.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_contact_max_correcting_vel.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_contact_max_correcting_vel.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_contact_max_correcting_vel.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_cfm.base = 0;
      u_cfm.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_cfm.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_cfm.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_cfm.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->cfm = u_cfm.real;
      offset += sizeof(this->cfm);
      union {
        double real;
      ...
      u_erp.base = 0;
      u_erp.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_erp.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_erp.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_erp.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->erp = u_erp.real;
      offset += sizeof(this->erp);
