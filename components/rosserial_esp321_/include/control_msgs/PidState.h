...
namespace control_msgs
{
  ...
  class PidState : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_error_dot.base = 0;
      u_error_dot.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_error_dot.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_error_dot.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_error_dot.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_p_error.base = 0;
      u_p_error.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_p_error.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_p_error.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_p_error.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_i_error.base = 0;
      u_i_error.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_i_error.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_i_error.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_i_error.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_d_error.base = 0;
      u_d_error.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_d_error.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_d_error.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_d_error.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_p_term.base = 0;
      u_p_term.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_p_term.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_p_term.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_p_term.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_i_term.base = 0;
      u_i_term.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_i_term.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_i_term.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_i_term.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_d_term.base = 0;
      u_d_term.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_d_term.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_d_term.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_d_term.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_i_max.base = 0;
      u_i_max.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_i_max.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_i_max.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_i_max.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_i_min.base = 0;
      u_i_min.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_i_min.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_i_min.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_i_min.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
