...
namespace shape_msgs
{
  ...
  class SolidPrimitive : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_st_dimensions.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_dimensions.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_dimensions.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_dimensions.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
